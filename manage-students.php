...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    $sql = "DELETE FROM student WHERE reg_id = $id";
...
if($num > 0){
    while($row = mysqli_fetch_assoc($result)){
        ...
        <tr>
            ...
            <td>
                <a href="edit-student.php?stid=<?php echo $row['reg_id'];?>"><i class="fa fa-edit" title="Edit Record" style="color: #007bff; margin-right: 10px;"></i> </a>
                <a href="manage-students.php?delete=<?php echo $row['reg_id'];?>" onclick="return confirm('Do you really want to delete this student?');"><i class="fa fa-trash" title="Delete Record" style="color: #dc3545;"></i> </a>
            </td>
        </tr>
        <?php
        $c++;
