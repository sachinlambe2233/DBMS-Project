...
if($num > 0){
    while($row = mysqli_fetch_assoc($result)){
        ...
        <tr>
            ...
            <td>
                <a href="edit-semester.php?semid=<?php echo $row['sem_id'];?>"><i class="fa fa-edit" title="Edit Record" style="color: #007bff; margin-right: 10px;"></i> </a>
                <a href="manage-sem.php?delete=<?php echo $row['sem_id'];?>" onclick="return confirm('Do you really want to delete this semester?');"><i class="fa fa-trash" title="Delete Record" style="color: #dc3545;"></i> </a>
            </td>
        </tr>
        <?php
        $c++;
