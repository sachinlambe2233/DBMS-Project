...
if($num > 0){
    while($row = mysqli_fetch_assoc($result)){
        ...
        <tr>
            ...
            <td>
                <a href="edit-branch.php?bid=<?php echo $row['branch_id'];?>"><i class="fa fa-edit" title="Edit Record" style="color: #007bff; margin-right: 10px;"></i> </a>
                <a href="manage-branch.php?delete=<?php echo $row['branch_id'];?>" onclick="return confirm('Do you really want to delete this branch?');"><i class="fa fa-trash" title="Delete Record" style="color: #dc3545;"></i> </a>
            </td>
        </tr>
        <?php
        $c++;
